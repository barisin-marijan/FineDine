...
namespace FineDine.Controllers
{
    public class EstablishmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Adress,WorkingHours,MainRating,Description")] Establishment establishment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Adress,WorkingHours,MainRating,Description")] Establishment establishment)
        {
            if (ModelState.IsValid)
            {
